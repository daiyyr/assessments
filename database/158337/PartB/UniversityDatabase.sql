-- script to create university database for the 2020 project Database 
--updated May 2020
...
'FL', '32320', '7155553907', 'JR', TO_DATE('10/10/1996', 'MM/DD/YYYY'), 1613, 1, TO_YMINTERVAL('3-0'));
...
(1, 'Fall 2017', 'CLOSED', '29-AUG-17');

INSERT INTO term (term_id, term_desc, status, start_date) VALUES
(2, 'Spring 2018', 'CLOSED', '09-JAN-18');

INSERT INTO term (term_id, term_desc, status, start_date) VALUES
(3, 'Summer 2018', 'CLOSED', '15-MAY-18');

INSERT INTO term (term_id, term_desc, status, start_date) VALUES
(4, 'Fall 2018', 'CLOSED', '28-AUG-18');

INSERT INTO term (term_id, term_desc, status, start_date) VALUES
(5, 'Spring 2019', 'CLOSED', '08-JAN-19');

INSERT INTO term (term_id, term_desc, status, start_date) VALUES
(6, 'Summer 2019', 'CLOSED', '18-MAY-19');

INSERT INTO term (term_id, term_desc, status, start_date) VALUES
(7, 'Fall 2019', 'CLOSED', '28-AUG-19');

INSERT INTO term (term_id, term_desc, status, start_date) VALUES
(8, 'Summer 2020', 'OPEN', '17-MAY-2020');

INSERT INTO term (term_id, term_desc, status, start_date) VALUES
(9, 'Spring 2020', 'OPEN', '09-JAN-2021');
...
INSERT INTO course_section VALUES
(17, 'MIS 500', 4, 1, 3, 'WRF', TO_DATE('11:00 AM', 'HH:MI AM'), TO_DSINTERVAL('0 00:02:50.00'), 8, 25);
